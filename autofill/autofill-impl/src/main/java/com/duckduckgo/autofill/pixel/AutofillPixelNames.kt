...
enum class AutofillPixelNames(override val pixelName: String) : Pixel.PixelName {
    ...
    AUTOFILL_SAVE_USERNAME_PROMPT_SHOWN("m_autofill_logins_save_username_inline_displayed"),
    AUTOFILL_SAVE_USERNAME_PROMPT_DISMISSED("m_autofill_logins_save_username_inline_dismissed"),
    AUTOFILL_SAVE_USERNAME_PROMPT_SAVED("m_autofill_logins_save_username_inline_confirmed"),
