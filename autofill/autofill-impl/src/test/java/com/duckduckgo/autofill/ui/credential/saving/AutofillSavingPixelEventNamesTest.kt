...
import com.duckduckgo.autofill.pixel.AutofillPixelNames.AUTOFILL_SAVE_USERNAME_PROMPT_DISMISSED
import com.duckduckgo.autofill.pixel.AutofillPixelNames.AUTOFILL_SAVE_USERNAME_PROMPT_SAVED
import com.duckduckgo.autofill.pixel.AutofillPixelNames.AUTOFILL_SAVE_USERNAME_PROMPT_SHOWN
...
class AutofillSavingPixelEventNamesTest {
    ...
    @Test
    fun whenSavingAcceptedWithUsernameOnlyThenCorrectPixelUsed() {
        assertEquals(pixelNameDialogAccepted(UsernameOnly), AUTOFILL_SAVE_USERNAME_PROMPT_SAVED)
    }
    ...
    @Test
    fun whenDialogShownWithUsernameOnlyThenCorrectPixelUsed() {
        assertEquals(pixelNameDialogShown(UsernameOnly), AUTOFILL_SAVE_USERNAME_PROMPT_SHOWN)
    }
    ...
    @Test
    fun whenDialogDismissedWithUsernameOnlyThenCorrectPixelUsed() {
        assertEquals(pixelNameDialogDismissed(UsernameOnly), AUTOFILL_SAVE_USERNAME_PROMPT_DISMISSED)
    }
