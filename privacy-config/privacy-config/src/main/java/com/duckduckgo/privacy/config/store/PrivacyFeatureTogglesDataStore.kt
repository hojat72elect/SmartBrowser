...
interface PrivacyFeatureTogglesDataStore {
    fun get(
        featureName: com.duckduckgo.privacy.config.api.PrivacyFeatureName,
        defaultValue: Boolean
    ): Boolean

    fun getMinSupportedVersion(featureName: com.duckduckgo.privacy.config.api.PrivacyFeatureName): Int
...
class PrivacyFeatureTogglesSharedPreferences constructor(private val context: Context) :
    ...
    override fun getMinSupportedVersion(featureName: com.duckduckgo.privacy.config.api.PrivacyFeatureName): Int {
