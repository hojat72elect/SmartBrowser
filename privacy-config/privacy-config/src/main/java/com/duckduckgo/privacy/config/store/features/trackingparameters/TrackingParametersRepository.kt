...
interface TrackingParametersRepository {
    ...
    val exceptions: List<com.duckduckgo.privacy.config.api.TrackingParameterException>
...
class RealTrackingParametersRepository(
    ...
    override val exceptions = CopyOnWriteArrayList<com.duckduckgo.privacy.config.api.TrackingParameterException>()
