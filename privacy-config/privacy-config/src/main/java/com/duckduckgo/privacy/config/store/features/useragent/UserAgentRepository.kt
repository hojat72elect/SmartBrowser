...
interface UserAgentRepository {
    ...
    val defaultExceptions: CopyOnWriteArrayList<com.duckduckgo.privacy.config.api.UserAgentException>
    val omitApplicationExceptions: CopyOnWriteArrayList<com.duckduckgo.privacy.config.api.UserAgentException>
    val omitVersionExceptions: CopyOnWriteArrayList<com.duckduckgo.privacy.config.api.UserAgentException>
}
...
class RealUserAgentRepository(
    ...
    override val defaultExceptions = CopyOnWriteArrayList<com.duckduckgo.privacy.config.api.UserAgentException>()
    override val omitApplicationExceptions = CopyOnWriteArrayList<com.duckduckgo.privacy.config.api.UserAgentException>()
    override val omitVersionExceptions = CopyOnWriteArrayList<com.duckduckgo.privacy.config.api.UserAgentException>()
