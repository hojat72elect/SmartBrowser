...
interface ContentBlockingRepository {
    ...
    val exceptions: CopyOnWriteArrayList<com.duckduckgo.privacy.config.api.ContentBlockingException>
}
...
class RealContentBlockingRepository(
    ...
    override val exceptions = CopyOnWriteArrayList<com.duckduckgo.privacy.config.api.ContentBlockingException>()
