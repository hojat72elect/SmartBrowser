...
interface AutofillRepository {
    ...
    val exceptions: CopyOnWriteArrayList<com.duckduckgo.privacy.config.api.AutofillException>
}
...
class RealAutofillRepository(
    ...
    override val exceptions = CopyOnWriteArrayList<com.duckduckgo.privacy.config.api.AutofillException>()
